...
class Momirintosh:
    ...
    def setup_momir_ui(self):
        ...
        self.btn_roll = PushButton(col_left, text="ROLL (Space)", command=self.get_random_card, width=20, height=2)
        ...
        self.card_image = Picture(col_right, image=DEFAULT_BACK, width=260, height=360)
