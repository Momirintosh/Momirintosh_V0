...
class Momirintosh:
    ...
    def print_qr(self):
        self.btn_qr_print.text = "printing.."
        self.btn_qr_print.bg = "#ff0000"
        self.btn_qr_print.disable()
        self.app.update()
        dev = None
        try:
            ...
            raw_img = Image.open("QR_CODE_small.bmp").convert("L")
    ...
    def reset_qr_button(self):
        self.btn_qr_print.text = "QR Code"
        self.btn_qr_print.bg = "white"
        self.btn_qr_print.enable()
    ...
    def setup_proxy_ui(self):
        ...
        self.btn_qr_print = PushButton(p_action_box, text="QR CODE", grid = [2,0], command=self.print_qr)
        self.btn_qr_print.bg = "white"
    # --- LOGIC HELPERS ---
